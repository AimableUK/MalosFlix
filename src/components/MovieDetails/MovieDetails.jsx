...
const MovieDetails = () => {
  return (
    <>
      <div className=' md:flex flex-row mt-7 w-full justify-center gap-20 pl-10 pr-10'>
        <img src={profpic} className='justify-self-center md:justify-start cursor-pointer min-w-10'/>
      ...
      <div className='flex flex-col p-10 bg-b bg-gradient-to-b from-black to-gray-900 min-h-screen'>
        <div className='flex flex-col mt-5 items-center'>
          <p className='font-imprima text-primary text-sm'>BEST TV SERIES</p>
          <p className='font-homenaje text-2xl'>World's Best TV Series</p>
        </div>
